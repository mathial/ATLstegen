...
class MatchsController extends Controller
{
  ...
  function getFormMatch($match, $mode) {
    ...
    ->add('context', ChoiceType::class, array(
      ...
      'choices' => array("Stege" => "Stege", "Stege (söndag 21-22)" => "Stege (söndag 21-22)", "Division League - Round#8" => "Division League - Round#8", "A-serien" => "A-serien", "Sprinttennis tournament" => "Sprinttennis tournament", "Summer tournament 2023 (june)" => "Summer tournament 2023 (june)", "Summer tournament 2023 (july)" => "Summer tournament 2023 (july)", "ATL Klubbmästerskap" => "ATL Klubbmästerskap"),
      'required'   => true,
    ))
