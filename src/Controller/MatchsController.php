...
class MatchsController extends Controller
{
  ...
  function getFormMatch($match, $mode) {
    ...
    ->add('context', ChoiceType::class, array(
      ...
      'choices' => array("Stege" => "Stege", "Stege (söndag 21-22)" => "Stege (söndag 21-22)", "Division League - Round#9" => "Division League - Round#9", "A-serien" => "A-serien", "Sprinttennis tournament" => "Sprinttennis tournament", "Summer tournament 2023 (august)" => "Summer tournament 2023 (august)", "ATL Klubbmästerskap" => "ATL Klubbmästerskap"),
      'required'   => true,
    ))
