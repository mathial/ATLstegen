...
$a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\RankingRepository' => function () {
    return ($this->privates['App\Repository\RankingRepository'] ?? $this->load('getRankingRepositoryService.php'));
}))));
