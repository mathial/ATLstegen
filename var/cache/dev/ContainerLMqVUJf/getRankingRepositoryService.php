...
// Returns the private 'App\Repository\RankingRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/RankingRepository.php';

return $this->privates['App\Repository\RankingRepository'] = new \App\Repository\RankingRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
