...
class Country extends \App\Entity\Country implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Country' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Country' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Country' . "\0" . 'flag'];
        }
     ...
     * {@inheritDoc}
     */
    public function setFlag(?string $flag): \App\Entity\Country
    {
